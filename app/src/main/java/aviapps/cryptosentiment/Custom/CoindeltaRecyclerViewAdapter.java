...
public class CoindeltaRecyclerViewAdapter extends RecyclerView.Adapter<CoindeltaRecyclerViewAdapter.ViewHolder> {
    private List<GetSetStream> values;
    private Context context;

    // Provide a suitable constructor (depends on the kind of dataset)
    public CoindeltaRecyclerViewAdapter(List<GetSetStream> myData, Context context) {
        values = myData;
    ...
    @Override
    public CoindeltaRecyclerViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // create a new view
